#
#  Be sure to run `pod spec lint HAPlayerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.license      = { :type => "MIT", :file => "LICENSE" }
  ...
  # Or just: s.author    = "Hipolito Arias"
  # s.authors            = { "Hipolito Arias" => "iecisa.drodrigue@iberia.es" }
